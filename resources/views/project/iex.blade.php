      ...
      <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-skin-blue sidebar-visible-desktop" id=sidebar-menu data-type=collapse>
        <div class="split-vertical">
                ...
                <div class="tab-pane active" id="sidebar-tabs-menu">
                  <div data-scrollable>
                    ...
                    <ul class="sidebar-menu sm-bordered sm-active-item-bg">
                      <li class="hasSubmenu text-multiple">
                        <a href="#components">
                    ...
                    <div class="sidebar-block text-center">
                      ...
                      <a class="btn btn-primary btn-block" href="http://themekit.frontendmatter.com/dist/themes/admin-angular/index.html">
                        <strong>AngularJS</strong>
                      </a>
                      <a class="btn btn-primary btn-block" href="http://themekit.frontendmatter.com/dist/themes/admin-rtl/index.html">
                        <strong>RTL</strong>
                      </a>
                    </div>
          ...
          <ul class="sidebar-menu sm-active-item-bg sm-icons-right sm-icons-block">
            <li><a href="http://themekit.frontendmatter.com/index.html"><i class="fa fa-eyedropper"></i> <span>Themes</span></a></li>
          </ul>
              ...
              <div class="item col-md-4 col-xs-12">
                <div class="panel panel-default">
                  <div class="embed-responsive embed-responsive-4by3">
                    <iframe class="embed-responsive-item" src="http://player.vimeo.com/video/50522981?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="100%" height="271" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                  </div>
