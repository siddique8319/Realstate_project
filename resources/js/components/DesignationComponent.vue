                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group form-control-default">
                              ...
                              <input  class="form-control" id="exampleInputFirstName" placeholder="Designation"  v-model="form.designation" type="text" name="designation" :class="{ 'is-invalid': form.errors.has('designation') }" >
...
<script>
   ...
   created() {
    ...
    methods: {
      ...
      add(){
         this.form.post('/index/designation-entry-create')
         .then(response => {
         ...
         deletePost(id)
      {
        let uri = `/index/deleteDesignation/${id}`;
