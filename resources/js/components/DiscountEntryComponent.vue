                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group form-control-default">
                             ...
                             <input  class="form-control" id="exampleInputFirstName" placeholder="Discount Entry"  v-model="form.discount" type="text" name="discount" :class="{ 'is-invalid': form.errors.has('dicount') }" >
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group form-control-default">
                              ...
                              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Start Date" name="start_date" v-model="form.start_date" >
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group form-control-default">
                              ...
                              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="End Date" name="end_date" v-model="form.end_date" >
                            </div>
                          </div>
...
<script>
   ...
   created() {
    ...
    methods: {
        add(){
         this.form.post('/index/discount-entry-create')
         .then(response => {
         this.msg= 'Your Data has been saved successfully!!!';
         let uri = '/api/discount';
         this.axios.get(uri).then(response => {
         this.discounts = response.data.data;
              });  
          })
    ...
    deletePost(id)
      {
      let uri = `/index/deleteDiscount/${id}`;
