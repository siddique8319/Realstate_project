                    ...
                    <div class="panel-body">
                      ...
                      <form  @submit.prevent="updatePost">
                         <div class="form-group"  >
                            ...
                            <select class="form-control" name="type"  v-model="form.type" id="exampleFormControlSelect1" >
                          ...
                          <div class="form-group"  >
                            ...
                            <select class="form-control" name="designation"  v-model="form.designation" id="exampleFormControlSelect1" >
...
<script>
   ...
   created() {
      ...
      let ur='/api/staff';
      let urr = `/post/editStaff/${this.$route.params.id}`; 
    ...
    methods: {
       updatePost() {
          let uri = `/post/updateStaff/${this.$route.params.id}`;
