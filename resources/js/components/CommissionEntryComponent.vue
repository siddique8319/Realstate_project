                    ...
                    <div class="panel-body">
                      ...
                      <form  @submit.prevent="add">
                         <div class="form-group"  >
                            ...
                            <select class="form-control"   v-model="form.commission_type" id="exampleFormControlSelect1" >
...
<script>
   ...
   created() {
    ...
    methods: {
         ...
         add(){
         this.form.post('/index/commissionEntry-entry-create')
         .then(response => {
         this.msg= 'Your Data has been saved successfully!!!';
         let uri = '/api/commissionEntry';
         this.axios.get(uri).then(response => {
         this.commissions = response.data.data;
              });  
          })
    ...
    deletePost(id)
      {
        let uri = `/index/deleteCommissionEntry/${id}`;
